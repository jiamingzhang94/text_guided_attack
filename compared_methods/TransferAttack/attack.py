...
class Attack(object):
    ...
    def load_model(self, model_name):
        ...
        Returns:hasattr(model, 'default_cfg')
        ...
        def load_single_model(model_name):
            if model_name in models.__dict__.keys():
                ...
                model_img_text , preprocessor = clip.load(model_name, device="cpu",jit=False,download_root="/new_data/yifei2/junhong/AttackVLM-main/model/clip")
                model = model_img_text.visual
            else:
    ...
    def loss_function(self, loss):
        ...
        if loss == 'crossentropy':
            ...
            return FixedCosineEmbeddingLoss()
        else:
