...
def parse_args():
    ...
    parser.add_argument("--cfg-path", default="ret_coco_eval.yaml", help="path to configuration file.")
...
def main():
    ...
    runner = RunnerBase(
        cfg=cfg, job_id=job_id, task=task, model=model, datasets=new_datasets
    )
